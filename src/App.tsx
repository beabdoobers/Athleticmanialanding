...
const App: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const numeroWhatsApp = "554333366115"; // Atualizado com o número fornecido
...
📝 Observações: ${formData.mensagem}`;
  ...
  return (
    <div className="landing-page">
      ...
      {/* 5. ESTRUTURA E SERVIÇOS (AGORA ACIMA DO FORM) */}
      <section className="section container">
        ...
        <div className="cards-grid" style={{gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))'}}>
          <div className="card" style={{borderStyle: 'dashed', padding: '25px'}}>
            ...
            <ul style={{listStyle: 'none', color: 'var(--text-dim)', fontSize: '0.95rem'}}>
              <li style={{display: 'flex', gap: '8px', alignItems: 'center'}}><CheckCircle2 size={14} color="var(--primary)"/> Entrada com acessibilidade</li>
            </ul>
          </div>
          <div className="card" style={{borderStyle: 'dashed', padding: '25px'}}>
            <h4>Comodidades</h4>
          ...
          <div className="card" style={{borderStyle: 'dashed', padding: '25px'}}>
            <h4>Pagamentos</h4>
            <ul style={{listStyle: 'none', color: 'var(--text-dim)', fontSize: '0.95rem', display: 'flex', flexDirection: 'column', gap: '5px'}}>
              <li style={{display: 'flex', gap: '8px', alignItems: 'center'}}><CheckCircle2 size={14} color="var(--primary)"/> Cartões de Crédito/Débito</li>
              <li style={{display: 'flex', gap: '8px', alignItems: 'center'}}><CheckCircle2 size={14} color="var(--primary)"/> Pagamento por Aproximação (NFC)</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="container contact-grid">
          <div className="contact-info">
            ...
            <div className="info-item" style={{marginTop: '25px'}}>
              ...
              <span>Av. Saul Elkind, 1030 - Londrina, PR</span>
            </div>
            ...
            <div className="info-item">
              ...
              <div style={{width: '100%'}}>
                ...
                <div style={{display: 'flex', flexDirection: 'column', gap: '5px', marginTop: '10px', fontSize: '0.9rem'}}>
                  <div style={{display: 'flex', justifyContent: 'space-between'}}><span>Seg a Sex</span> <span>08h-12h | 14h-22h</span></div>
            ...
            <form onSubmit={handleSubmit} className="premium-form">
              <div className="input-row">
                <div className="input-field">
                  ...
                  <input type="text" required placeholder="Ex: Gustavo Felício" value={formData.nome} onChange={(e) => setFormData({...formData, nome: e.target.value})}/>
                </div>
                <div className="input-field">
                  <label>WhatsApp</label>
                  <input type="tel" required placeholder="(43) 99999-9999" value={formData.telefone} onChange={(e) => setFormData({...formData, telefone: e.target.value})}/>
                </div>
              </div>
              <div className="input-row">
                <div className="input-field">
                  <label>Objetivo</label>
                  <select value={formData.objetivo} onChange={(e) => setFormData({...formData, objetivo: e.target.value})}>
                ...
                <div className="input-field">
                  ...
                  <select value={formData.jaTreina} onChange={(e) => setFormData({...formData, jaTreina: e.target.value})}>
              ...
              <div className="input-field">
                ...
                <textarea rows={3} placeholder="Conte um pouco sobre suas metas..." value={formData.mensagem} onChange={(e) => setFormData({...formData, mensagem: e.target.value})}></textarea>
              </div>
...
// Ícone do Instagram SVG simples para evitar erro de importação
const InstagramIcon = () => (
